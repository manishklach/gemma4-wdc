...
def scenario_tasks(name: str) -> list[TaskSubmission]:
    ...
    scenarios = {
        ...
        "coding_overlap": [
            TaskSubmission(task_id="scan-1", agent_id="coder-1", branch_id="feat-runtime", task_type="repo_scan", resource_hint="repo:agent-runtime-lab", payload={"repo": "agent-runtime-lab", "path": "runtime/", "query": "Find where shared execution units transition from pending to executing"}),
            TaskSubmission(task_id="scan-2", agent_id="coder-2", branch_id="feat-bench", task_type="repo_scan", resource_hint="repo:agent-runtime-lab", payload={"repo": "agent-runtime-lab", "path": "runtime/", "query": "Locate the state machine that moves shared execution units into execution"}),
            TaskSubmission(task_id="code-1", agent_id="coder-3", branch_id="feat-ui", task_type="code_search", resource_hint="repo:agent-runtime-lab", payload={"repo": "agent-runtime-lab", "path": "backend/app", "query": "metrics collector for deduplication multiplier"}),
        ],
